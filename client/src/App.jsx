...
function AdminPanel({ email }) {
  ...
  return (
    <div style={{ position: 'fixed', top: 20, right: 20, background: 'rgba(255,0,0,0.2)', border: '2px solid #ff0000', borderRadius: 8, padding: 16, color: '#fff', fontFamily: "'Segoe UI', sans-serif", fontSize: 12, zIndex: 999 }}>
...
return (
    <div style={{
      ...
      <div style={{textAlign:'center', marginBottom:'40px', zIndex:1}}>
        ...
        <p style={{color:'#fff',fontSize:'16px',fontWeight:'600',marginTop:'12px',letterSpacing:'2px'}}>v1.4</p>
      </div>
