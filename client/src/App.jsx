...
function AdminPanel({ email }) {
  ...
  return (
    <div style={{ position: 'fixed', bottom: 20, right: 20, background: 'rgba(255,0,0,0.2)', border: '2px solid #ff0000', borderRadius: 8, padding: 16, color: '#fff', fontFamily: "'Segoe UI', sans-serif", fontSize: 12, zIndex: 999 }}>
...
return (
    <div style={{
      ...
      <div style={{textAlign:'center', marginBottom:'clamp(12px, 2vh, 20px)', zIndex:1, maxWidth:'100%', padding:'0 12px', flex:'0 1 auto'}}>
        ...
        <p style={{color:'#fff',fontSize:'clamp(10px, 2vh, 13px)',fontWeight:'600',margin:'4px 0 0 0',letterSpacing:'1px'}}>v2.10</p>
      </div>
